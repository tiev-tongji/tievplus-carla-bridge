...
class LaneLine
{
    ...
    public:
        ...
        /// single solid white, single solid yellow
        // If you're using C++11 and are getting compiler errors saying
        // things like â€˜constexprâ€?needed for in-class initialization of
        // static data member then re-run lcm-gen with '--cpp-std=c++11'
        // to generate code that is compliant with C++11
        static const int8_t   kTypeTypeNoPass = 0x01;
        /// double solid white, double solid yellow
        // If you're using C++11 and are getting compiler errors saying
        // things like â€˜constexprâ€?needed for in-class initialization of
        // static data member then re-run lcm-gen with '--cpp-std=c++11'
        // to generate code that is compliant with C++11
        static const int8_t   kTypeOneWayPass = 0x02;
        /// double solid&broken white, double solid&broken yellow
        // If you're using C++11 and are getting compiler errors saying
        // things like â€˜constexprâ€?needed for in-class initialization of
        // static data member then re-run lcm-gen with '--cpp-std=c++11'
        // to generate code that is compliant with C++11
...
int LaneLine::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __int32_t_encode_array(buf, offset + pos, maxlen - pos, &this->line_type, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int LaneLine::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &this->line_type, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
uint64_t LaneLine::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0x6d7f200dd3b63485LL +
